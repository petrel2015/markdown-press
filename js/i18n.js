...
(function (global) {
  ...
  var DICT = {
    en: {
      ...
      methAria: 'Methodology and notes',
      methKicker: 'Methodology & notes',
      methTitle: 'How this page works',
      methLede: 'MD·PRESS is a self-contained Markdown workbench: every note below describes what happens on your machine, and the credits table names the open-source components that do the work.',
      methRenderK: 'Rendering',
      methRenderB: 'Markdown is parsed by marked and highlighted by highlight.js inside the browser; Mermaid is loaded from local vendor files only when a document contains a diagram.',
      methExportK: 'Export',
      methExportB: 'A4 PDF goes through the browser print pipeline (vector text); phone and A4 images are rasterised locally by html-to-image. Nothing is uploaded.',
      methPrivacyK: 'Privacy',
      methPrivacyB: 'Documents and preferences persist in localStorage on this device only — no account, no analytics, no third-party calls; on-demand scripts are fetched from this site, not a CDN.',
      methColComp: 'Component',
      methColRole: 'Role',
      methRdEditor: 'Source editor',
      methRdMd: 'Markdown → HTML',
      methRdHl: 'Code highlighting',
      methRdDiag: 'Diagrams',
      methRdPng: 'PNG rasterisation',
      methRdQr: 'Donation QR codes',
      methRdFont: 'Typeface · via tufte-css',
      methDisc: 'Provided as-is — the tool runs entirely in your browser; keep your own backups.',
    ...
    zh: {
      ...
      methKicker: '方法论与说明',
      methTitle: '本页工作方式',
      methLede: 'MD·PRESS 是一个自包含的 Markdown 工作台：以下各条说明的全部过程都发生在你的浏览器里，来源表列出承担各项工作的开源组件。',
      methRenderK: '渲染',
      methRenderB: 'Markdown 由 marked 在浏览器内解析、highlight.js 完成代码高亮；Mermaid 仅在文档包含图表时才从本地 vendor 文件加载绘制。',
      methExportK: '导出',
      methExportB: 'A4 PDF 走浏览器打印管线（矢量文本）；手机长图与 A4 图片由 html-to-image 在本地栅格化，不上传任何数据。',
      methPrivacyK: '隐私',
      methPrivacyB: '文档与偏好仅保存在本设备的 localStorage——无账号、无统计、不调用第三方服务；按需加载的脚本来自本站而非外部 CDN。',
      methColComp: '组件',
      methColRole: '职责',
      methRdEditor: '源码编辑器',
      methRdMd: 'Markdown → HTML',
      ...
      methRdPng: 'PNG 栅格化',
      methRdQr: '赞赏二维码',
      methRdFont: '正文字体 · 来自 tufte-css',
      methDisc: '本工具完全在浏览器中运行，按「现状」提供——请自行做好文档备份。',
